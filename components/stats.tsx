      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Nuestro <span className="gradient-text">Enfoque</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {principles.map((principle, index) => {
            ...
            return (
              <div
                key={index}
                className="text-center group p-6 rounded-xl glass-panel-light hover:glass-panel transition-all hover:scale-105"
              >
                <div className="inline-flex items-center justify-center w-16 h-16 mb-4 rounded-xl bg-secondary/50 border border-border group-hover:scale-110 transition-transform">
